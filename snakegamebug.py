...
if snake_pos[0] == food_pos[0] and snake_pos[1] == food_pos[1]:
    ...
    snake_body.pop()
    score += 1  # Simulated bug: Score increases even if the snake doesn't eat the food
...
# Display "Game Made by: Aldrien Velasco" message
author_text = font.render("Game Made by: Aldrien Velasco", True, WHITE)
win.blit(author_text, (WIDTH // 2 - author_text.get_width() // 2, HEIGHT // 2 + 200))  # Adjust the vertical position if needed
